...
Status: agreed by the team (2026-09-19). Phases 1 to 6 (and 2b) are done (see section 10). Phase 7's
code is done and its live exit check is pending (it runs with phase 8's live runs); phase 8 is not
started.
