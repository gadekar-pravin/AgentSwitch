...
Status: agreed by the team (2026-09-19). Phases 1 to 6 (and 2b) are done (see section 10); phase 7 and
later are not started.
...
| 7 | Spans file and judge sidecar, `--judge` | `deterministic` verdicts unchanged; offline test 12 passes: a forced `judge_failed` changes neither verdict nor exit code |
