...
| Domain learning plan (Step 1) | [docs/domain-learning-plan.md](docs/domain-learning-plan.md) | UI walk done (2026-09-17); draft date test skipped; schema reads and notes cleanup open |
